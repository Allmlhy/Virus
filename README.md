...
| 国家代码      | 国家代码     | 国家唯一标识              |
| 国家名称      | 国家名称     | 国家名称                  |
| 地区代码【列表】 | 地区代码【列表】 | 该国家对应的地区列表      |
| 世卫名称      | 世卫名称     | 世界卫生组织中的名称      |
...
| Asia             | 亚洲                | 各地区的疫苗数据                           |
| Europe           | 欧洲                | 各地区的疫苗数据                           |
| European Union   | 欧盟                | 各地区的疫苗数据                           |
| North America    | 北美洲              | 各地区的疫苗数据                           |
| South America    | 南美洲              | 各地区的疫苗数据                           |
| Oceania          | 大洋洲              | 各地区的疫苗数据                           |
| World            | 全球                | 全球的疫苗数据                             |
| Id               | 主键编号            | 自增主键                                   |
| 国家代码         | 国家代码            | 外键，关联 Country 表                      |
| date_id          | 日期                | 记录数据的统计日期                        |
| 累计接种剂次     | 累计接种剂次        | 截至该日期为止的累计接种剂次              |
| 接种过疫苗人数   | 接种过疫苗人数      | 截至该日期为止的接种过疫苗人数            |
| 完全接种人数     | 完全接种人数        | 截至该日期为止的完全接种人数              |
| 每日接种剂次     | 每日接种剂次        | 每日新增的接种剂次                        |
| 每日新增接种人数 | 每日新增接种人数    | 每日新增接种过疫苗人数                    |
