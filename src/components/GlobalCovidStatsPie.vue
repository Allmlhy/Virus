...
.container {
  ...
  border-radius: 16px;
  box-shadow: 0 6px 24px rgba(66, 139, 212, 0.15);
}
...
select {
  ...
  color: #333;
  box-shadow: 0 1px 3px rgba(38, 195, 190, 0.3);
}
...
.stats-card {
  ...
  border-radius: 12px;
  padding: 20px;
  box-shadow: 0 4px 12px rgba(38, 195, 190, 0.15);
  margin-bottom: 30px;
  font-size: 16px;
  display: flex;
  gap: 24px;
...
.chart {
  ...
  background: #fff;
  border-radius: 12px;
  box-shadow: 0 3px 10px rgba(66, 139, 212, 0.1);
  padding: 20px;
}
</style>
