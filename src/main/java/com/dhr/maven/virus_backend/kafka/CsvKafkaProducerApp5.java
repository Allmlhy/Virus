...
@Component
public class CsvKafkaProducerApp5 {

    @Autowired
    private KafkaTemplate<String, String> kafkaTemplate;

    private final String TOPIC = "world_daily_stats_va";

    public void sendCsv() throws Exception {
        String path = "src/main/java/com/dhr/maven/virus_backend/kafka/data/世界各国数据_无疫苗_cleaned.csv";
